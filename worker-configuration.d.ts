/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 61ea6fbb592aa2ac824cd54ef1d24171)
...
interface __BaseEnv_Env {
	...
	ROOMS: DurableObjectNamespace<import("./src/worker/index").TransferRoom>;
	SESSION_LIMITERS: DurableObjectNamespace<import("./src/worker/index").ClientSessionLimiter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "TransferRoom" | "ClientSessionLimiter";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "STATS_R2_BUCKET_NAME" | "ROOM_TTL_SECONDS" | "TURN_TTL_SECONDS" | "SPILLOVER_CAP_BYTES" | "MAX_RELAY_REQUEST_BYTES">> {}
}
